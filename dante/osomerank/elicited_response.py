...
def har_prediction(texts, platform):
    ...
    try:
        ...
        logger.warning(f"Failed to generate HAR scores. Returning AVG_SCORES['{platform.lower()}']['HAR']: {e}")
        return default_har
...
def ar_prediction(texts, platform):
    ...
    try:
        ...
        logger.warning(
            f"Failed to generate AR scores. Returning default AVG_SCORES['{platform.lower()}']['AR']: {e}"
        )
        return default_ar