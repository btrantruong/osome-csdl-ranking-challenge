...
# Package imports
from .utils import remove_urls, gets3, get_logger, getconfig
...
def main():
    ...
    s3_resource.Object(s3_bucket,
                       "data/topic_modelling_training_data.csv").put(
